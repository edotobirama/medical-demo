        ...
        <div className="min-h-screen bg-slate-50 flex flex-col font-sans">
            ...
            <div className="flex-1 container mx-auto px-6 py-24 max-w-4xl">
                <div className="text-center mb-16">
                    <h1 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6 font-heading">Parking & Campus Map</h1>
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-12">
                    <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
                        ...
                        <h2 className="text-xl font-bold text-slate-900 mb-3">Visitor Parking Garage</h2>
                    ...
                    <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
                        ...
                        <h2 className="text-xl font-bold text-slate-900 mb-3">Valet Services</h2>
                        ...
                        <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 flex justify-between items-center">
                            <span className="font-semibold text-slate-700">Standard Valet Fee</span>
