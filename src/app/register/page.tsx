        ...
        <div className="min-h-screen flex bg-background text-foreground">
            ...
            <div className="hidden lg:flex lg:w-1/2 relative bg-gray-900 text-white">
                ...
                <div className="relative z-10 flex flex-col justify-end p-16 w-full">
                    <h1 className="text-4xl font-bold mb-4">Join Grandview Medical</h1>
                    <p className="text-lg text-gray-300 max-w-md">
                        Create your account to schedule appointments, access your history, and manage your health journey.
                    </p>
                </div>
            </div>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 lg:p-16">
                <div className="w-full max-w-md space-y-8">
                    ...
                    <form action={formAction} className="space-y-6">
                        ...
                        <button
                            className={clsx(
                                "w-full flex justify-center py-3 px-4 border border-transparent rounded-xl shadow-sm text-sm font-medium text-white bg-emerald-600 hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 transition-all disabled:opacity-70 disabled:cursor-not-allowed",
