                ...
                <div className="container mx-auto px-6 relative z-20">
                    <div className="max-w-2xl">
                        <div className="flex items-center gap-4 mb-6 animate-in fade-in slide-in-from-left duration-700">
                            ...
                            <div>
                                <p className="text-sm font-semibold text-primary uppercase tracking-widest">Center of Excellence</p>
                                <h1 className="text-5xl lg:text-7xl font-bold text-foreground tracking-tight">Cardiology <span className="text-primary">Center</span></h1>
                            </div>
                        </div>
            ...
            <section className="container mx-auto px-6 py-24">
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
                    ...
                    <div className="flex gap-2">
                        <div className="px-4 py-2 bg-primary/10 text-primary rounded-full text-sm font-bold border border-primary/20">6,000+ Surgeries</div>
                        <div className="px-4 py-2 bg-primary/10 text-primary rounded-full text-sm font-bold border border-primary/20">24/7 Support</div>
                    </div>
                </div>
