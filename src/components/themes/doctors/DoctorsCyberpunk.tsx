...
export default function DoctorsCyberpunk({ doctors = [] }: { doctors?: any[] }) {
                        ...
                        <div key={index} className="bg-[#00f3ff]/5 border border-[#00f3ff]/30 p-2 relative group hover:border-[#ff00ff] hover:bg-[#ff00ff]/5 transition-colors">
                            ...
                            <div className="px-2 pb-2">
                                ...
                                <p className="text-xs text-[#00f3ff]/70 mb-3 ml-2 border-l border-[#00f3ff]/50 pl-2">
                                    SPEC: {doctor.specialty || doctor.doctorProfile?.specialization}<br />
                                    STATUS: AVAILABLE
                                </p>
                                <Link href={`/doctors/${doctor.id}`} className="w-full py-2 border border-[#00f3ff] text-[#00f3ff] text-xs font-bold uppercase hover:bg-[#00f3ff] hover:text-black transition-colors flex items-center justify-center gap-2">
                                    <Activity size={12} /> View Profile
                                </Link>
                            </div>
                        </div>
                    ))}
